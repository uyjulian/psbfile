...
public:
  ...
  psb_value_t(const psb_t &psb, type_t type, unsigned char *&p);
  psb_value_t(const psb_t &psb, unsigned char *&p);

  virtual ~psb_value_t(void);

  type_t         get_type(void) const;
  virtual string get_type_string() const { return "psb_value_t"; }
...
public:
  ...
  enum psb_number_type_t { INTEGER, FLOAT, DOUBLE };

  psb_number_t(const psb_t &psb, unsigned char *&p, psb_value_t::type_t type);

  float             get_float() const;
  double            get_double() const;
  int64_t           get_integer() const;
  psb_number_type_t get_number_type() const { return number_type; }

  static bool is_number_type(psb_value_t *value);

  virtual string get_type_string() const { return "psb_number_t"; }
...
public:
  psb_array_t(const psb_t &psb, unsigned char *&p, psb_value_t::type_t type);
  ...
  virtual string get_type_string() const { return "psb_array_t"; }
};
/***************************************************************************
 * psb_string_t
 */
...
public:
  psb_string_t(const psb_t &psb, unsigned char *&p);
  ...
  virtual string get_type_string() const { return "psb_string_t"; }
};
/***************************************************************************
 * psb_objects_t
 */
...
public:
  psb_objects_t(const psb_t &psb, unsigned char *&p);
  ...
  template <class T>
  void unpack(T *&out, const string &name) const;

  virtual string get_type_string() const { return "psb_objects_t"; }
...
public:
  psb_collection_t(const psb_t &psb, unsigned char *&p);
  ...
  template <class T>
  void unpack(T *&out, uint32_t index) const;

  virtual string get_type_string() const { return "psb_collection_t"; }
...
public:
  ...
  bool get_number(unsigned char *p, psb_number_t::psb_number_value_t &value,
  ...
  template <class T>
  void unpack(T *&out, unsigned char *&p) const;
...
template <class T>
void psb_objects_t::unpack(T *&out, const string &name) const {
  out = NULL;
...
template <class T>
void psb_collection_t::unpack(T *&out, uint32_t index) const {
...
template <class T>
void psb_t::unpack(T *&out, unsigned char *&p) const {
